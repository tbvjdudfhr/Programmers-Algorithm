...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> stack1_1 = new ArrayList<>();
        ArrayList<Integer> stack2_1 = new ArrayList<>();
        stack1_1.add(1);
        stack1_1.add(2);
        stack2_1.add(3);
        stack2_1.add(4);
        ...
        ArrayList<Integer> stack1_2 = new ArrayList<>();
        ArrayList<Integer> stack2_2 = new ArrayList<>();
        stack1_2.add(1);
        stack1_2.add(2);
        stack1_2.add(3);
